...
using Hi.DevOps.TimeSheet.API.Application.BusinessManager;
using Hi.DevOps.TimeSheet.API.Application.DataBaseRepo;
using Hi.DevOps.TimeSheet.API.Application.Helpers;
using Hi.DevOps.TimeSheet.API.Application.IBusinessManager;
using Hi.DevOps.TimeSheet.API.Application.IDataBaseRepo;
using Hi.DevOps.TimeSheet.API.DataObject.Authorize;
...
namespace Hi.DevOps.TimeSheet.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ITimeSheetBM, TimeSheetBM>();
            services.AddScoped<ITimeSheetRepo>(c => new TimeSheetRepo(Configuration["ConnectionString:Path"]));
