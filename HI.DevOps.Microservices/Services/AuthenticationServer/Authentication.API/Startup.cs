...
using Hi.DevOps.Authentication.API.Application.BussinessManager;
using Hi.DevOps.Authentication.API.Application.BussinessManagerInterface;
using Hi.DevOps.Authentication.API.Application.DatabaseRepo;
...
namespace Hi.DevOps.Authentication.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IJwtFactoryBm, JwtFactoryBm>();
            services.AddScoped<IJwtFactoryRepo>(c => new JwtFactoryRepo(Configuration["ConnectionString:Path"]));
